 ...
 *
 */
public class StrongEnemy extends Rectangle implements EnemyType{
	/**
	 * Size of enemy
	 */
	 ...
	 */
	public StrongEnemy(int enemyId,LinkedList<Point> enemyPath, int movePoint,int actualHealth,int currentHealth,int value,int enemyActualSpeed,int enemyCurrentSpeed)
	{	
